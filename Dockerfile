...
#RUN yum -y install python-psutil python-jsonschema python-websockify python-psutil novnc nginx python-jsonschema python-psutil spice-html5 python2-crypto

RUN yum -y install /tmp/ginger.el7.centos.noarch.rpm 
RUN yum -y install /tmp/wok.el7.centos.noarch.rpm 
RUN yum -y install /tmp/ginger-base.el7.centos.noarch.rpm 
RUN yum -y install /tmp/kimchi.el7.centos.noarch.rpm
